...
from poiseuille.components.connectors import ProctorAndGambleConnector, LinearResistanceConnector
...
def run():
    ...
    c = [ProctorAndGambleConnector(d=6, l=25) for i in range(10)]
